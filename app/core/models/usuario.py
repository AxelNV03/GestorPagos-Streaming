...
class Usuario(db.Model):
    ...
    def plataformas(self):
        return [s.plataforma for s in self.suscripciones if s.activo]

    @property
    def nombres_plataformas(self):
        """
        Útil para mostrar en tablas: retorna una cadena tipo 'Netflix, Disney+'
        """
        return ", ".join([s.plataforma.nombre for s in self.suscripciones if s.activo])
    # ===================================================================================================
    def __repr__(self):
